...
PHONE_METADATA_KZ = PhoneMetadata(id='KZ', country_code=7, international_prefix='810',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:33622|(?:7\\d|80)\\d{3})\\d{5}', possible_length=(10,)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='7\\d{9}', example_number='7710009998', possible_length=(10,)),
